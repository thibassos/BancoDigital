...
public abstract class Seguro {
    ...
    public Seguro(int numeroSeguro, int numeroCartaoSegurado, int numeroApoliceSeguro,
                  LocalDate dataContratacao, LocalDate dataVencimento,double valorIndenizacao) {
